...
exp = design.Experiment(name = "Launch_speed")
...
for i in range(30):
    square2.move((10,0))
    exp.clock.wait(7) #The increase of speed makes it seem like the green square is "fleeing" the red square instead of being launched by it
